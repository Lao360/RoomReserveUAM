...
var MonthlyCalendar = (function() {
    ...
    function renderCalendar(year, month) {
        ...
        var tableBody = document.querySelector('#calendar-month tbody');
        tableBody.innerHTML = '';
    ...
    function selectDate(date, year, month) {
        ...
        var calendarCells = document.querySelectorAll('#calendar-month td');
        ...
        document.getElementById('selected-date-info').textContent = `Wybrałeś ${day}.${monthFormatted}.${yearFormatted}`;
    }
